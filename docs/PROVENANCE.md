...
`RELEASE_VERSION.json` binds the release candidate to backend source commit `45a447e64e33de7c7b08fedf4c0bbee774b6c1e4`, TeamHarness `1.0.42`, installer plugin `1.4.2`, and web Git tree `fdf7d7332162fe240c608087d63eb1b4ac9b0e4a`. The tagged release commit may add only release metadata, documentation, or release verification tooling and must descend from that backend source commit.
